            ...
            <div id="layoutSidenav_content">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header ash"><h3 class="text-center font-weight-light my-4">Featured Item</h3></div>
                                    <div class="card-body">                                   
                                    </div>
                                </div>
                            </div>
               ...
               <br> <br> <br>
                ...
                <h2 class="h2">
                 ...
                 <br>
                 <h2 class="h2"><strong>Product Type:</strong>
                 <?php   
                   echo $user[0]['product_type'];
                 ?>
                 </h2>
                 <br>
                 <h2 class="h2"><strong>Price:</strong>
                 <?php   
                   echo $user[0]['price'];
                 ?>
                 </h2>
                 <br>
                 <h2 class=" h2 h3"><strong>Info:</strong>
                 <?php   
                   echo $user[0]['info'];
                 ?>
                 </h2>
