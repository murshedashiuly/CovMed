        ...
        <div id="layoutSidenav">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header color"><h3 class="text-center font-weight-light my-4">Admin Profile</h3></div>
                                    <div class="card-body">                                   
                                    </div>
                                </div>
                            </div>
            ...
            <?php  foreach ($user as $user) {  ?>
                 ...
                 <!--  <tr>
                    ...
                    <td><?=$user['gender']?></td>
                    <td><?=$user['ages']?></td>
                    <td><a href="<?=base_url()?>admin/change_admin/<?=$user['id']?>"><button class="btn btn-primary">Setting</button></a></td>
                  </tr> -->
                  <div class="part1">
                      <div class="col-xl-3 col-md-6">
                            <div class="card color  mb-4">
                                <div class="card-body"><strong>Admin Name</strong></div>
                    ...
                    <div class="part2">
                        ...
                        <div class="col-xl-3 col-md-6 width">
                            <div class="card color  mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a href="<?=base_url()?>admin/change_admin/<?=$user['id']?>"><button class="btn btn-primary center1">Setting</button></a>
                                    <div class="small "></div>
                                </div>
                            </div>
                        </div>
