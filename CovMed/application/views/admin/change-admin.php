                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header ash"><h3 class="text-center font-weight-light my-4">Admin Setting</h3></div>
                                    <div class="card-body">
			                    ...
			                    <div class="row clearfix">
			                        ...
			                        <div class="col-md-6 column">
			                         ...
			                         <div class="form-group">
                                        ...
                                        <div class="form-group">
                                        <label for="exampleInputEmail1">Address</label>
                                        <textarea name="type" class="form-control"><?php if(set_value('type')){ echo set_value('type'); }else{ echo $user[0]['type']; } ?></textarea>            
                                        </div>
