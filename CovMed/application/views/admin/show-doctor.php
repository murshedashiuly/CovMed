            ...
            <div id="layoutSidenav_content">
                ...
                <!-- add items start -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header ash"><h3 class="text-center font-weight-light my-4">See Doctor List</h3></div>
                                    <div class="card-body">                                   
                                    </div>
                                </div>
                            </div>
			      ...
			      <?php  foreach ($user as $user) {?>
                    ...
                    <tr>
                    <?php 
                    echo '<td><a href="'.base_url().'asset/images/'.$user['doctor_image'].'"><img width="100px;" height="100px" src="'.base_url().'asset/images/'.$user['doctor_image'].'" alt=""></a></td>'; ?>

                    <td><?=$user['doctor_name']?></td>
                    <td><?=$user['number']?></td>
                    <td><?=$user['hospital']?></td>
                    <td><?=$user['division']?></td>
                    <td><a href="<?=base_url()?>admin/edit_doctor/<?=$user['id']?>"><button class="btn btn-primary">Change</button></a></td>
                    <td><a href="<?=base_url()?>admin/delete_doctor/<?=$user['id']?>"><button class="btn btn-danger">Delete</button></a></td>
