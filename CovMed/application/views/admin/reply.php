                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header ash"><h3 class="text-center font-weight-light my-4">Message</h3></div>
                                    <div class="card-body">                                   
                                    </div>
                                </div>
                            </div>
            ...
            <?php  foreach ($user as $user) {  ?>
                ...
                <?php if($user['type']!= 'admin') { ?>
                  <tr>
                   ...
                   <td><a href="<?=base_url()?>admin/reply1/<?=$user['c_id']?>"><button class="btn btn-primary">reply</button></a></td>
                  </tr>
