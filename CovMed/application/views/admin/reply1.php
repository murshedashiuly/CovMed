                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header ash"><h3 class="text-center font-weight-light my-4">Admin Reply</h3></div>
                                    <div class="card-body ">
				                    ...
				                    <div class="row clearfix">
				                        <div class="col-md-6 column"> 
				                          ...
				                          <div class="form-group">
				                            ...
				                            <input type="text" name="admin_reply" class="form-control" value="<?php if(set_value('admin_reply')){ echo set_value('admin_reply'); }else{ echo $user[0]['admin_reply']; } ?>" id="exampleInputEmail1" aria-describedby="emailHelp">
				                          </div>
				                          <div class="error"><?=form_error('admin_reply')?></div>
