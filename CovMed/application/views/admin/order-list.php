                ...
                <!-- add items start -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header ash"><h3 class="text-center font-weight-light my-4">See Order List</h3></div>
                                    <div class="card-body">                                   
                                    </div>
                                </div>
                            </div>
                 ...
                 <table  class="table table-responsive text-center" id="grid">
			      ...
			      <tr>
			        ...
			        <th class="text-center">Order Mobile</th>
			      ...
			      <tr>
			        ...
			        <td><?=$user['address']?></td>
			        <td><?=$user['date']?></td> 
			        <td><a href="<?=base_url()?>admin/delete_order/<?=$user['o_id']?>"><button class="btn btn-danger">Cancel</button></a></td>
			      </tr>
