        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header color"><h3 class="text-center font-weight-light my-4">User Profile</h3></div>
                                    <div class="card-body">                                   
                                    </div>
                                </div>
                            </div>
               ...
               <!--  <div class="profile text-center">
                	<h2 class="h2"><strong>Name:</strong>
                 <?php   
                   echo $user[0]['name'];
                 ?>
                 </strong></h2>
                 <br>
                 <h2 class="h2"><strong>Email:</strong>
                 <?php   
                   echo $user[0]['email'];
                 ?>
                 </h2>
                 <br>
                 <h2 class="h2"><strong>Mobile:</strong>
                 <?php   
                   echo $user[0]['mobile'];
                 ?>
                 </h2>
                 <br>
                 <h2 class="h2"><strong>Address:</strong>
                 <?php   
                   echo $user[0]['user_address'];
                 ?>
                 </h2>
                 <br>
                 <h2 class="h2"><strong>Blood Group:</strong>
                 <?php   
                   echo $user[0]['blood_group'];
                 ?>
                 </h2>
                 <br>
                 <h2 class="h2"><strong>Gender:</strong>
                 <?php   
                   echo $user[0]['gender'];
                 ?>
                 </h2>
                 <br>
                 <h2 class="h2"><strong>Ages:</strong>
                 <?php   
                   echo $user[0]['ages'];
                 ?>
                 </h2>
              ...
              <div class="part1">
                  <div class="col-xl-3 col-md-6">
                        <div class="card color mb-4">
                            <div class="card-body"><strong>User Name</strong></div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card color mb-4">
                            <div class="card-body"><strong>Email</strong></div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                               <?php   
                                   echo $user[0]['email'];
                                ?>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card color mb-4">
                            <div class="card-body"><strong>Mobile</strong></div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                               <?php   
                                   echo $user[0]['mobile'];
                                ?>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card color mb-4">
                            <div class="card-body"><strong>Address</strong></div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                               <?php   
                                   echo $user[0]['user_address'];
                                ?>
                ...
                <div class="part2">
                    <div class="col-xl-3 col-md-6 width">
                        <div class="card color mb-4">
                            <div class="card-body"><strong>Blood Group</strong></div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                               <?php   
                                   echo $user[0]['blood_group'];
                                ?>
                    ...
                    <div class="col-xl-3 col-md-6 width">
                        <div class="card color mb-4">
                            <div class="card-body"><strong>Gender</strong></div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                               <?php   
                                   echo $user[0]['gender'];
                                ?>
                    ...
                    <div class="col-xl-3 col-md-6 width">
                        <div class="card color mb-4">
                            <div class="card-body"><strong>Ages</strong></div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                               <?php   
                                   echo $user[0]['ages'];
                                ?>
