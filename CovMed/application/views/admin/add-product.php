                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header ash"><h3 class="text-center font-weight-light my-4">Add Product</h3></div>
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                           ...
                                           <!--  <div class="form-group">
                                            ...
                                            <select  name="product_type" class="form-control" >               
                                                <option value="product_type">Please Select Product</option>
                                                <option value="mask" <?php if(set_value('product_type')=='mask') { echo 'selected'; } ?> >Mask</option>
                                                <option value="sanitizer" <?php if(set_value('product_type')=='sanitizer') { echo 'selected'; } ?> >Sanitizer</option>
                                                <option value="gloves" <?php if(set_value('product_type')=='gloves') { echo 'selected'; } ?> >Gloves</option>
                                                <option value="wipes" <?php if(set_value('product_type')=='wipes') { echo 'selected'; } ?> >Wipes</option>
                                            </select>
                                         </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" class="form-control" value="<?=set_value('price')?>" placeholder="Enter Product Price" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="info" class="form-control" value="<?=set_value('info')?>" placeholder="Enter Product Info" id="exampleInputEmail1" aria-describedby="emailHelp">
