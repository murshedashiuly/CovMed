            ...
            <div id="layoutSidenav_content">
                ...
                <!-- add items start -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header ash"><h3 class="text-center font-weight-light my-4">See User List</h3></div>
                                    <div class="card-body">                                   
                                    </div>
                                </div>
                            </div>
			      ...
			      <?php  foreach ($user as $user) {  ?>
                    ...
                    <td><?=$user['email']?></td>
                    <td><?=$user['mobile']?></td>
                    <td><a href="<?=base_url()?>admin/user_profile/<?=$user['id']?>"><button class="btn btn-primary">Profile</button></a></td>
