            ...
            <div class="">
                <div class="container">
                    <div class="wrapper-box text-center">
                        <h4>To contact with us please make sure you are logged in <br>if you don't have any account please sign up fast. </h4>
                    </div>
                </div>
            </div>
            <br> <br>
             <div class="cus_r_con mb-0 text-center">
                    <div class="link-btn"><a href="#" class="theme-btn btn-style-two" data-toggle="modal" data-target="#appointment2">Contact Form</a></div>
                </div>
